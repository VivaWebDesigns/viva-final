...
export const user = pgTable("user", {
  ...
  includeInActivityIntelligence: boolean("include_in_activity_intelligence").notNull().default(true),
...
export const localFalconProspectProfiles = pgTable("local_falcon_prospect_profiles", {
  ...
  state: text("state"),
  zip: text("zip"),
  scanCenterLat: numeric("scan_center_lat"),
  scanCenterLng: numeric("scan_center_lng"),
  scanCity: text("scan_city"),
  scanState: text("scan_state"),
  scanZip: text("scan_zip"),
  phone: text("phone"),
  ...
  heatmapSizeBytes: integer("heatmap_size_bytes"),
  heatmapSha256: text("heatmap_sha256"),
  snapshotStorageKey: text("snapshot_storage_key"),
  snapshotOriginalName: text("snapshot_original_name"),
  snapshotMimeType: text("snapshot_mime_type"),
  snapshotSizeBytes: integer("snapshot_size_bytes"),
  snapshotSha256: text("snapshot_sha256"),
  snapshotGeneratedAt: timestamp("snapshot_generated_at"),
  solv: numeric("solv"),
  ...
  websiteCondition: text("website_condition"),
  tier: text("tier"),
  pitchType: text("pitch_type"),
  pitchSummary: text("pitch_summary"),
  sosLookupDone: boolean("sos_lookup_done"),
  sosEntityFound: boolean("sos_entity_found"),
  licenseRecordFound: boolean("license_record_found"),
  createdAt: timestamp("created_at").defaultNow().notNull(),
}, (t) => [
...
export const marketplacePendingOutreach = pgTable("marketplace_pending_outreach", {
  ...
  index("mpo_deleted_at_idx").on(t.deletedAt),
  index("mpo_deleted_by_idx").on(t.deletedBy),
]);
