...
export async function getScanReportEmailPreview(
  ...
  return {
    ...
    message: spanish
      ...
      : `Hi${greeting},\n\nWe prepared this local visibility scan to show how ${businessName} appears on Google Maps when customers search for “${record.report.scanKeyword}.”\n\nIf you’d like, I can walk you through what the results show and the opportunities we found.`,
    businessName,
