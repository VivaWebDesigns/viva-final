      ...
      res.json({
        ...
        data: {
          ...
          market: resolveLocalVisibilityMarket({
            scanCity: record.profile.scanCity,
            scanState: record.profile.scanState,
            prospectCity: record.profile.city,
            prospectState: record.profile.state,
            batchCity: record.batch.marketCity,
            batchState: record.batch.marketState,
          }).label,
