...
2. Once the sending provider accepts the email, a New Lead moves to **Report Emailed**. The list and snapshot show **1 of 2 sent**. A task to send the second email is due three business days later.
