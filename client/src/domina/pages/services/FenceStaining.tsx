...
import serviceFenceParallax from "@/assets/images/parallax/fence.webp";
...
export default function FenceStaining() {
  ...
  useEffect(() => {
    document.title = "Fence Staining & Painting Charlotte, NC | Charlotte Painting Pro";
    const meta = document.querySelector('meta[name="description"]');
    if (meta) {
      meta.setAttribute("content", "Professional fence staining and painting services in Charlotte, NC. Protect and beautify your fence. Free estimates from Charlotte Painting Pro.");
    }
    
    const ogTags = [
      { property: "og:title", content: "Fence Staining & Painting Charlotte, NC | Charlotte Painting Pro" },
      { property: "og:description", content: "Professional fence staining and painting services in Charlotte, NC. Protect and beautify your fence. Free estimates from Charlotte Painting Pro." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://charlottepaintingpro.com/services/fence-staining" },
    ];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section ref={containerRef} className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden" data-testid="hero-fence-staining">
        ...
        >
          <img 
            src={serviceFenceParallax} 
            alt="Fence Staining Charlotte" 
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          <h2 className="text-3xl font-bold mb-6" style={{ fontFamily: 'var(--font-display)' }}>{t.fencePage.whatIsTitle}</h2>
          <p className="text-muted-foreground leading-relaxed mb-4">
            {t.fencePage.whatIsP1}
          </p>
          <p className="text-muted-foreground leading-relaxed">
            {t.fencePage.whatIsP2}
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-secondary">
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          <h2 className="text-3xl font-bold mb-6" style={{ fontFamily: 'var(--font-display)' }}>{t.fencePage.whyMattersTitle}</h2>
          <p className="text-muted-foreground leading-relaxed mb-4">
            {t.fencePage.whyMattersP1}
          </p>
          <p className="text-muted-foreground leading-relaxed mb-4">
            {t.fencePage.whyMattersP2}
          </p>
          <p className="text-muted-foreground leading-relaxed">
            {t.fencePage.whyMattersP3}
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <h2 className="text-3xl font-bold mb-12 text-center" style={{ fontFamily: 'var(--font-display)' }}>{t.fencePage.processTitle}</h2>

          {(() => {
            const steps = [
              { title: t.fencePage.step1Title, text: t.fencePage.step1Text },
              { title: t.fencePage.step2Title, text: t.fencePage.step2Text },
              { title: t.fencePage.step3Title, text: t.fencePage.step3Text },
              { title: t.fencePage.step4Title, text: t.fencePage.step4Text },
            ];
            return (
              <>
      ...
      <section className="py-16 md:py-20 bg-primary text-primary-foreground text-center">
        <div className="container mx-auto px-4 md:px-6 max-w-2xl">
          <h2 className="text-3xl font-bold mb-4" style={{ fontFamily: 'var(--font-display)' }}>{t.fencePage.ctaTitle}</h2>
          ...
          <Link href="/contact#contact-form">
            <Button data-testid="button-final-cta" className="bg-white text-primary font-semibold px-8 py-3 text-base hover:bg-white/90">
              {t.fencePage.scheduleEstimate}
              <ArrowRight className="ml-2" size={18} />
            </Button>
          </Link>
          <p className="text-primary-foreground/60 text-sm mt-6">
            <Link href="/portfolio?filter=fence" className="underline hover:text-primary-foreground/80">{t.fencePage.viewPortfolio} &rarr;</Link>
            {" · "}
            <Link href="/services" className="underline hover:text-primary-foreground/80">{t.fencePage.viewAllServices}</Link>
            {" · "}
            <Link href="/services/deck-staining" className="underline hover:text-primary-foreground/80">{t.fencePage.deckStaining}</Link>
          </p>
        </div>
      </section>
