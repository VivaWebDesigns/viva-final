          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-foreground text-sm mb-0.5">{t.contact.emailUs}</h3>
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-foreground text-sm mb-0.5">{t.contact.callUs}</h3>
