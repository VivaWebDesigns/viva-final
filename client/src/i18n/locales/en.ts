export const en = {
  ...
  settings: {
    ...
    activityIntelDescription: "Include this sales rep in Activity Intelligence stats.",
    activityIntelSalesOnly: "Only sales reps are counted in Activity Intelligence.",
