      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24 relative z-10">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href={`tel:+19804754924`} className="text-gray-400 text-sm hover:text-white transition-colors duration-200" data-testid="link-footer-phone">{t("global.phone")}</a>
              </li>
              <li className="flex items-start gap-3">
        ...
        <div className="mt-20 pt-8 border-t border-white/10">
          ...
          <p className="text-gray-600 text-sm text-center sm:text-left mt-3" data-testid="text-service-area">
            We serve Spanish-speaking clients across the United States.
          </p>
        </div>
      </div>
    </footer>
