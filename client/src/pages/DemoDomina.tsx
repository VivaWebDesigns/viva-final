...
export default function DemoDomina() {
  const cfg = demoConfig.domina;
  const colors = tierColors[cfg.color];

  return (
    <div className="min-h-screen bg-[#0d0d0d] flex flex-col" data-testid="page-demo-domina">
      <DemoBar activeTier="domina" />
        ...
        <div className={`rounded-2xl border ${colors.border} ${colors.bg} p-10 max-w-lg w-full text-center flex flex-col items-center gap-6`}>
          ...
          {cfg.url ? (
            <a
              ...
              data-testid="button-open-demo-domina"
            ...
            <div className="flex flex-col items-center gap-3 py-4" data-testid="msg-demo-not-connected-domina">
