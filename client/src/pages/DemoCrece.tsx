...
export default function DemoCrece() {
  const cfg = demoConfig.crece;
  const colors = tierColors[cfg.color];

  return (
    <div className="min-h-screen bg-[#0d0d0d] flex flex-col" data-testid="page-demo-crece">
      <DemoBar activeTier="crece" />
        ...
        <div className={`rounded-2xl border ${colors.border} ${colors.bg} p-10 max-w-lg w-full text-center flex flex-col items-center gap-6`}>
          ...
          {cfg.url ? (
            <a
              ...
              data-testid="button-open-demo-crece"
            ...
            <div className="flex flex-col items-center gap-3 py-4" data-testid="msg-demo-not-connected-crece">
