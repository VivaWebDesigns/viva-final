...
export default function Contacto() {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      {/* FORM SECTION */}
      <section className="py-24 lg:py-40 bg-white dark:bg-[#0d0d0d] relative overflow-hidden" data-testid="section-contacto-form">
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-gray-700 dark:text-gray-300 font-semibold">Email Address</FormLabel>
                          <FormControl>
                            <Input type="email" placeholder="you@example.com" className="h-12 bg-[#f5f5f5] dark:bg-[#111] border-gray-200 dark:border-gray-700" data-testid="input-email" {...field} value={field.value ?? ""} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                          ...
                          <div className="flex items-start gap-3 py-1">
                            ...
                            <div className="space-y-1.5">
                              ...
                              <p className="text-xs leading-relaxed text-gray-500 dark:text-gray-500 select-none">
                                I agree to receive SMS text messages from Viva Web Designs related to my inquiry, requested information, appointments, reminders, and service updates. Message frequency may vary. Message and data rates may apply. Reply STOP to opt out and HELP for help. Consent is not a condition of purchase. See our{" "}
                                <PrivacyPolicyModal
                                  trigger={
                                    <span
                                      data-privacy-trigger="true"
