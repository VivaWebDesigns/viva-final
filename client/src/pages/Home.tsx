  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="py-24 lg:py-40 bg-[#111] relative overflow-hidden" data-testid="section-before-after">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-px bg-gradient-to-r from-transparent via-[#FF0080]/30 to-transparent shadow-[0_0_100px_40px_rgba(255,0,128,0.1)] pointer-events-none" />
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-px bg-gradient-to-r from-transparent via-[#FF0080]/30 to-transparent shadow-[0_0_100px_40px_rgba(255,0,128,0.1)] pointer-events-none" />
