  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="py-24 lg:py-40 bg-[#111] relative overflow-hidden" data-testid="section-before-after">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-[2px] bg-gradient-to-r from-transparent via-[#0D9488] to-transparent shadow-[0_0_60px_20px_rgba(13,148,136,0.6)] pointer-events-none" />
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-[2px] bg-gradient-to-r from-transparent via-[#0D9488] to-transparent shadow-[0_0_60px_20px_rgba(13,148,136,0.6)] pointer-events-none" />
