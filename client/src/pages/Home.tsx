  ...
  return (
    <div className="overflow-x-hidden bg-white text-[#061a3d]">
      ...
      <section className="relative isolate overflow-hidden bg-[#001426] pt-[62px] text-white" data-testid="section-hero">
        <div
          className="absolute inset-0 bg-no-repeat bg-[length:100%_auto] bg-[position:center_center] max-md:bg-[length:104%_auto] max-md:bg-[position:center_96px]"
        ...
        <div className="relative z-10 mx-auto flex min-h-[648px] max-w-7xl flex-col px-4 py-7 sm:px-6 md:min-h-[556px] lg:px-8">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="mb-0 mt-[315px] max-w-[355px] drop-shadow-[0_2px_10px_rgba(0,0,0,0.72)] md:mb-5 md:mt-[42px]" data-testid="card-hero-content">
