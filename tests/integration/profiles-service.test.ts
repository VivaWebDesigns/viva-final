 ...
 * ─────────────────────────────────────────────────────────────────────────────
 * Layer:       INTEGRATION — requires a live Postgres database.
 * Run with:    npm run test:integration
 * ─────────────────────────────────────────────────────────────────────────────
 *
 * Validates that the three profile entry paths produce a consistent,
 * stable UnifiedProfileDto against real DB data.  Positive-path tests
 * gracefully skip when the seeded DB has no relevant rows.
 *
 * For hermetic unit tests (no DB) see:
