 ...
 * ─────────────────────────────────────────────────────────────────────────────
 *
 * Validates that the SQL aggregation queries execute correctly and return
 * internally consistent results (shape, math, boundary invariants) against
 * real seeded data.
 *
 * For hermetic unit tests (no DB) see:
 *   tests/unit/report-aggregations.test.ts
 */
